...
function ZestTable({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: `overflow-x-auto ${className}`, children: /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("table", { className: "min-w-full border border-gray-200 dark:border-zinc-700 rounded-lg", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("tbody", { children: sortedData.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
      "td",
      {
    ...
    ) }) : sortedData.map((row, idx) => /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
      "tr",
      {
